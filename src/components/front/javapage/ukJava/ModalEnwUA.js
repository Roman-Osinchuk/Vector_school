...
import '../ukJava/Modalww.css';

const ModalEnUA = ({ isOpen, onClose, text }) => {
    ...
    <div className="modal-overlay1" onClick={onClose}>
      <div className="modal1" onClick={(e) => e.stopPropagation()}>
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="submit-btn1" disabled={!isFormValid || loading}>
