...
import '../../webpage/mainWeb/Contactsww.css';
...
import RekvizytyModal from '../ukJava/RekvizitEnww'; 
    ...
    <section id="contacts" className="sectionContacts">
      ...
      <div className="contacts-container">
        <div className="contact-info">
          <h2>CONTACTS</h2>
          <p><img src={locationIcon} alt="Location icon" className="contact-icon" /> Khmelnytskyi, 63 Prosukivskogo Pidpillia St. (Atrium Shopping Center, 3rd Floor)</p>
          <p><img src={phoneIcon} alt="Phone icon" className="contact-icon" /> +380673825500</p>
          <p><img src={clockIcon} alt="Clock icon" className="contact-icon" /> Mon-Sun: 10:00 AM - 6:00 PM</p>
          <p><img src={emailIcon} alt="Email icon" className="contact-icon" /> sales@vector.com.ua</p>
          <button className="rekvizyty-btn" onClick={openModal}>Details</button>
          <div className="links-container">
            <a href="https://vector-school.online/%D1%83%D0%BC%D0%BE%D0%B2%D0%B8-%D0%BD%D0%B0%D0%B4%D0%B0%D0%BD%D0%BD%D1%8F-%D0%BF%D0%BE%D1%81%D0%BB%D1%83%D0%B3-%D1%82%D0%B0-%D0%BF%D0%BE%D0%B2%D0%B5%D1%80%D0%BD%D0%B5%D0%BD%D0%BD%D1%8F-%D0%BA%D0%BE%D1%88%D1%82%D1%96%D0%B2.pdf" className="link">Service Terms and Refund Policy</a><br />
            <a href="https://vector-school.online/%D0%B4%D0%BE%D0%B3%D0%BE%D0%B2%D1%96%D1%80-java.pdf" className="link">Web Development Contract</a>
          </div>
        </div>
